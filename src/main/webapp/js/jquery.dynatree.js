...
DynaTreeNode.prototype = {
	...
	_getInnerHtml: function() {
		...
		// Checkbox mode
		if( opts.checkbox && data.hideCheckbox !== true && !data.isStatusNode && data.attributes.nodeType != opts.limitNodeType) {
...
//				this.tree.logDebug("nodeTitle: " + nodeTitle);
				...
				if(data.subtitle) {
					nodeTitle += '<span class="alert alert-info" style="margin-left: 5px;padding: 0px;">（' + data.subtitle + '）</span>'
				} else {
					nodeTitle += '<span></span>';
				}
			}
