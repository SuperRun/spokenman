...
<head>
    ...
    <script type="text/javascript" src="<%=path %>/media/js/do/hr/announcement/update.js"></script>
</head>
<link rel="stylesheet"
...
<div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="block block-two">
                    ...
                    <div class="block-heading"><span>通告修改</span></div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="body" name="body"
                                                  style="height: 324px;">${ann.text}</textarea>
                                    </div>
                                </div>
                                <div class="form-group">
    ...
    <form class="form-horizontal" id="fileUploadForm" action="<%=path %>/announcement/file"
          role="form" method="post" enctype="multipart/form-data">
        <!-- 实际的file控件 -->
        <input id="useFile" type="file" name="useFile" style="display:none">
    </form>
    <input id="annId" value="${ann.id}" type="text" style="display:none">
    <!--footer end-->
</div>
<script>
  ...
  window.onload = function() {
    ...
    > $(".content .row .col-md-9").height() ? $("#attach_part").height()
      + 20 : $(".content .row .col-md-9").height();
    console.log(height);
    $(".content .row .col-md-3").css("height", height);
  };

  $(".date").datetimepicker({
    format: 'yyyy-mm-dd hh:ii', startView: 3, language: 'zh-CN'
  });
