    ...
    <div class="layui-main" style="min-height: 400px">
		<div class="layui-row path">
			<div class="layui-row path">
				...
				<span><a href="/unitUser/resourcesManage">培训资源管理</a></span>
				<i class="path-split">\</i>
        ...
        <form class="layui-form" action="">
            ...
            <div class="layui-inline">
                <button type="button" class="layui-btn layui-btn-primary rsearch-bar-btn" id="addbtn" @click="addResource" data-method="setTop">新增</button>
            </div>                
        </div>
        </form>
...
<#include "../../footer.ftl">
<script src="../../js/resources/unitUser/resourcesManage.js"></script>
