...
<head>
    ...
    <script src="${path}/media/js/do/hr/driver/index.js"></script>
                                ...
                                <tr>
                                    ...
                                    <c:if test="${loginedMemberProvince}">
                                        <td class="text-center">
                                            <a  href="<%=basePath %>driver/${driver.id }/update" ><button class="btn-custom btn-middle btn-table">修改</button></a>
...
<div style="display: none">
    <form action="<%=basePath%>driver" method="post" id="data" name="data">
