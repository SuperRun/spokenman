...
{ 
	...
	s += '<div style="width: 200px;"><table class="tableborder" cellspacing="0" cellpadding="0"  style="text-align: center; width:200px; height:210px;">'; 
 
	s += '<tr align="center" class="header1"><td class="header1"><a href="#" onclick="refreshcalendar(yy, mm-1);return false" title="上一月"><<</a></td><td colspan="5" style="text-align: center" class="header1"><a href="#" onclick="showdiv(\'year\');_cancelBubble(event);return false" title="点击选择年份" id="year"></a>年<a id="month" title="点击选择月份" href="#" onclick="showdiv(\'month\');_cancelBubble(event);return false"></a>月</td><td class="header1"><A href="#" onclick="refreshcalendar(yy, mm+1);return false" title="下一月">>></A></td></tr>'; 
...
{ 
	...
	$$('calendar_' + id).style.top = (p['y'] + 36)+'px'; 
