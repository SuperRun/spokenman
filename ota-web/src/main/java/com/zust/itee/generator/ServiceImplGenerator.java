...
public class ServiceImplGenerator {
    ...
    private static final String UPSERT = "    @Override\n"
            ...
            + "        log.info(\"==插入或更新%s== description:{}\", %s);\n"
            + "        if (%s.getId() == null || getById(%s.getId()) == null)"
            + " {\n"
            + "            log.info(\"==插入或更新%s，插入%s== description:{}\", %s);\n"
            + "            return %s.save(%s);\n"
            + "        } else {\n"
            + "            log.info(\"==插入或更新%s，更新%s== description:{}\", %s);\n"
            + "            return %s.update(%s);\n"
            + "        }\n"
            + "    }\n"
            + "\n";
    ...
    public static final String LIST_BY_FILTER = "    @Override\n"
            ...
            + "page, Integer limit){\n"
            + "        log.info(\"==精准查询%s== description:{},page:{},limit:{}\",%s,page,limit);\n"
