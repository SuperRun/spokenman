 ...
 * @param basePath
 */
function deirectToEditPaper(examId,basePath){
	location.href=basePath+"paper/member/"+examId+"/select";
}
 ...
 * @param basePath
 */
function deirectToEditExam(examId,basePath){
	location.href=basePath+"exam/member/edit/"+examId+"";
}
 ...
 * @param examId
 */
function conveyExamIdForDelete(examId){
	$("#examIdForDelete").val(examId);
}
 ...
 * @param basePath
 */
function confirmDeleteExam(basePath){
	examId = $("#examIdForDelete").val();
	$.ajax({
		url:basePath+"exam/member/"+$("#examIdForDelete").val(),
		method:'DELETE',
 ...
 * @param basePath
 */
function forwordToSetAnnouncement(examId,basePath){
	location.href=basePath+"exam/member/"+examId+"/announcement";
}
