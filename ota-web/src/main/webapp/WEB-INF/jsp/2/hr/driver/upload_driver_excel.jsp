...
<head>
    ...
    <script src="<%=path%>/media/js/do/hr/driver/upload_driver_excel.js"></script>
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="block block-two">
                ...
                <div class="block-heading"><span>驾驶员Excel导入</span></div>
                <div class="block-body">
                    <div class="col-md-12">
                        <form class="form-horizontal employee_form">
                            ...
                            <br>
                            <a href="<%=path%>/media/excel/tdriver.xlsx" >导入Excel模板下载</a>
...
<!--message end-->
<form class="form-horizontal" id="picUploadForm" action="<%=path %>/driver/excel" role="form" method="post" enctype="multipart/form-data" >
    <!-- 实际的file控件 -->
