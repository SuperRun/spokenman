...
<head lang="en">
    ...
    <link href="<%=basePath%>media/2/css/exam_driver_practice.css"
            ...
            <div class="col-md-3">
                <div class="block block-two">
                    ...
                    <div class="block-body text-center">
                        ...
                        <p class="name">
                            考生姓名：<span
                                class="nickname ellipsis">${examingBaseInfo.driverName }</span>
                        </p>
                                ...
                                <ul id="answer_list">
                                    <c:forEach items="${question.questionItems }"
                                        ...
                                        <c:if
                                            ...
                                            <li class="answer_item"><span
                                                    class="">${questionItem.sequence }</span>&nbsp;<span
                                                    class="answer_content">${questionItem.content }</span>
                                            </li>
                                        </c:if>
                                        <!-- 图片选项 -->
                                        <c:if
                                ...
                                <c:if test="${!empty question.questionItems }">
                                    ...
                                    <ul id="user_answer">
                                        <c:forEach items="${question.questionItems }"
                                            ...
                                            <c:if test="${questionItem.sequence==question.answerPre }">
                                                <li class="ua_item answer_hover"><a href="#"
                                                                                    onclick="selectQuestionItems('${questionItem.sequence}')">${questionItem.sequence }</a>
                                                </li>
                                            </c:if>
                                            <c:if test="${questionItem.sequence!=question.answerPre }">
                            ...
                            <c:forEach items="${changeQuestion.sequenceStatus }" var="state"
                                ...
                                <c:if test="${idx.index+1!=changeQuestion.sequenceNow }">
                                    ...
                                    <c:if test="${state==false }">
                                        <!-- 未答题 -->
                                        <li class="row0"><a
                                                href="javascript:changeQuestion('${idx.index+1 }');">${idx.index+1 }</a>
                                        </li>
                                    </c:if>
                                </c:if>
                            </c:forEach>
