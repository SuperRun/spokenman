		...
		<div class="row">
			...
			<div class="col-md-9">
				...
				<div class="block block-two">
					...
					<form action="<%=basePath%>question/edit/${questionId}"
						method="post" id="questionImport">
						<div style="display:none">
							<input type="text" id="content" name="content"> <input
								type="text" id="pic1" name="pic1" value="${question.pic1 }">
							<input type="text" id="pic2" name="pic2"
								value="${question.pic2 }"> <input type="text" id="pic3"
								name="pic3" value="${question.pic3 }"> <input
								type="text" id="typeId" name="typeId"> <input
								type="text" id="subjectId" name="subjectId"> <input
								type="text" id="marks" name="marks"> <input type="text"
								id="answer" name="answer"> <input type="text"
								id="difficulty" name="difficulty"> <input type="text"
					...
					<div class="block-body">
						<div class="col-md-12">
							<div class="form-horizontal question_form" id="question_form">
								<div class="form-group">
									<div class="col-md-6">
										<label for="questionType" class="text_title">试题类型：</label> <select
											...
											onchange="conveyQuestionTypeScore()">
											<c:forEach items="${questionTypes }" var="questionType">
												<c:if test="${questionType.id!=question.typeId }">
													<option value="${questionType.id }"
														score="${questionType.score }">${questionType.name}</option>
												</c:if>
												<c:if test="${questionType.id==question.typeId }">
													<option value="${questionType.id }"
														score="${questionType.score }" selected="selected">${questionType.name}</option>
												</c:if>
											</c:forEach>
										</select>
									</div>
									...
									<div class="col-md-6">
										<label class="text_title" for="knowledge">试题知识点：</label><select
											...
											<c:forEach items="${questionSubjects }" var="questionSubject">
												<c:if test="${questionSubject.id!=question.subjectId }">
													<option value="${questionSubject.id }">${questionSubject.name }</option>
												</c:if>
												<c:if test="${questionSubject.id==question.subjectId }">
													<option value="${questionSubject.id }" selected="selected">${questionSubject.name }</option>
												</c:if>
											</c:forEach>
								...
								<div class="form-group">
									<div class="col-md-6">
										<label class="text_title" for="score">分值：</label> <input
											...
											disabled="disabled" id="score" value="${question.marks}">
									</div>
									<div class="col-md-6">
										<label class="radio-inline" for="easy"> <c:if
												test="${question.difficulty=='易' }">
												<input type="radio" value="1" name="difficulty" id="easy"
													checked>
											</c:if> <c:if test="${question.difficulty!='易' }">
												<input type="radio" value="1" name="difficulty" id="easy">
											</c:if> 易
										</label> <label class="radio-inline" for="medium"> <c:if
												test="${question.difficulty=='中' }">
												<input type="radio" value="2" name="difficulty" id="medium"
													checked>
											</c:if> <c:if test="${question.difficulty!='中' }">
												<input type="radio" value="2" name="difficulty" id="medium">
											</c:if> 中
										</label> <label class="radio-inline" for="difficult"> <c:if
												test="${question.difficulty=='难' }">
												<input type="radio" value="3" name="difficulty"
													id="difficult" checked>
											</c:if> <c:if test="${question.difficulty!='难' }">
												<input type="radio" value="3" name="difficulty"
													id="difficult">
											</c:if> 难
										</label>
								...
								<div class="form-group">
									<div class="col-md-12">
										...
										<textarea id="question" class="form_textarea"
											placeholder="题干内容">${question.content }</textarea>
											...
											<div class="col-sm-4 name_div text-center">
												...
												<c:if test="${!empty question.pic1 &&question.pic1!='' }">
													<img src="<%=basePath %>${question.pic1}"
														class="question-pic" id="questionPic1Preview">
												</c:if>
											...
											<div class="col-sm-4 name_div text-center">
												...
												<c:if test="${!empty question.pic2 &&question.pic2!='' }">
													<img src="<%=basePath %>${question.pic2}"
														class="question-pic" id="questionPic2Preview">
												</c:if>
								...
								<!-- 单选题 -->
								<c:if
									test="${!empty question.typeId &&(question.typeId==642||question.typeId==642)}">
									<div class="form-group" id="answer-input"
										style="display: none;">
										<div class="col-md-12">
									...
									<!-- 原先为文字选项 -->
									<c:if test="${question.questionItemType=='font' }">
														...
														<div class="option_item original_item">
															...
															<div class="col-sm-8 name_div" style="padding-left: 0;">
																<input type="text" placeholder="选项内容"
																	class="form-control" name="question_item_content" value="${questionItem.content }">
															</div>
															...
															<c:if test="${!status.first }">
																<div class="col-sm-1 name_div">
																	<input type="button" class="btn btn-default delete-btn"
																		value="删除" style="margin-left: 10px">
																</div>
															</c:if>
															<div class="col-sm-1 name_div"></div>
														</div>
												...
												<div class="col-sm-10 option_div">
													<div class="option_item original_item">
														...
														<div class="col-sm-2 name_div">
															<img src="" class="question-pic"> <input
																type="text" class="img_url" name="question_item_pic">
														</div>
														<div class="col-sm-1 file-upload">
															<input type="button" class="btn btn-default new-btn"
																value="+">
												...
												<div class="col-sm-10 option_div">
													<div class="option_item">
														<div class="col-sm-1 radio_div">
															<input type="radio" class="radio" name="estimateOption"
																value="A">
														</div>
														<div class="col-sm-11" style="padding-left: 0;">
															<input type="text" class="form-control"
																disabled="disabled" value="正确">
														</div>
													</div>
													<div class="option_item">
														<div class="col-sm-1 radio_div">
									...
									<!-- 原先为图片选项 -->
									<c:if test="${question.questionItemType=='picture' }">
										<div class="form-group" id="option-type">
											<div class="col-md-12">
												<label class="col-sm-2 text_title">选项类型：</label>
												<div class="col-sm-10 name_div">
													<label class="radio-inline"> <input type="radio"
														name="optionType" value="font" id="font">文字
													</label> <label class="radio-inline"> <input type="radio"
														name="optionType" value="picture" id="picture" checked>图片
													</label>
												</div>
											</div>
										</div>
											...
											<div class="col-md-12">
												...
												<div class="col-sm-10 option_div">
													<div class="option_item original_item">
														...
														<div class="col-sm-8 name_div" style="padding-left: 0;">
															<input type="text" placeholder="选项内容"
																class="form-control" name="question_item_content">
														</div>
														<div class="col-sm-1 name_div">
															<input type="button" class="btn btn-default new-btn"
																value="+">
												...
												<div class="col-sm-10 option_div">
													<c:forEach items="${question.questionItems }"
														...
														<div class="option_item original_item">
															...
															<div class="col-sm-2 name_div">
																<img src="<%=basePath %>${questionItem.pic }" class="question-pic">
																<input type="text" class="img_url"
																	name="question_item_pic" value="${questionItem.pic }">
															</div>
															<!-- 最后一个选项后可＋ -->
															<c:if test="${status.last}">
																<div class="col-sm-1 file-upload">
								...
								<!-- 多选题 -->
								<c:if
									test="${!empty question.typeId &&(question.typeId=='669'||question.typeId==669)}">
											...
											<div class="col-md-12">
												...
												<div class="col-sm-10 option_div">
													<c:forEach items="${question.questionItems }"
														var="questionItem" varStatus="status">
														<div class="option_item original_item">
															<div class="col-md-1 checkbox_div select_type">
																<c:if
																	test="${!empty questionItem.selected && questionItem.selected }">
																	<input type="checkbox" class="checkbox"
																		name="fontOption" checked>
																</c:if>
											...
											<div class="col-md-12">
												...
												<div class="col-sm-10 option_div">
													<c:forEach items="${question.questionItems }"
														var="questionItem" varStatus="status">
														<div class="option_item original_item">
															<div class="col-md-1 check_div file-upload select_type">
																<c:if
																	test="${!empty questionItem.selected && questionItem.selected }">
																	<input type="checkbox" class="checkbox"
																		name="picOption" checked>
																</c:if>
															...
															<div class="col-sm-6 file-upload file_part"
																...
																<input type="text" class="file_input form-control"
																	disabled="disabled">
																<button class="btn btn-primary file_btn" onclick="clickPicItemBtn(event)">选择图片</button>
															</div>
															<div class="col-sm-2 name_div">
																<img src="<%=basePath %>${questionItem.pic }"
																	class="question-pic"> <input type="text"
																	class="img_url" name="question_item_pic"
																	value="${questionItem.pic }">
															</div>
															<c:if test="${status.last }">
																<div class="col-sm-1 file-upload">
																	<input type="button" class="btn btn-default new-btn"
								...
								<!-- 判断题 -->
								<c:if
									test="${!empty question.typeId && (question.typeId=='643'||question.typeId==643) }">
									<div class="form-group" id="answer-input"
										style="display: none;">
										<div class="col-md-12">
											<label class="col-sm-2 text_title">答案：</label>
									...
									<div class="form-group" id="option-type" style="display:none">
										<div class="col-md-12">
											<label class="col-sm-2 text_title">选项类型：</label>
											<div class="col-sm-10 name_div">
												<label class="radio-inline"> <input type="radio"
										...
										<div class="col-md-12">
											...
											<div class="col-sm-10 option_div">
												<div class="option_item">
													<div class="col-sm-1 radio_div">
														<c:if
															test="${!empty question.answer && question.answer=='A'}">
															<input type="radio" class="radio" name="estimateOption"
																value="A" checked>
														</c:if>
												...
												<div class="option_item">
													<div class="col-sm-1 radio_div">
														<c:if
															test="${!empty question.answer && question.answer=='B'}">
															<input type="radio" class="radio" name="estimateOption"
																value="B" checked>
														</c:if>
								...
								<!-- 填空题或者简答题 -->
								<c:if
									test="${!empty question.typeId &&(question.typeId==670||question.typeId==671||question.typeId=='670'||question.typeId=='671')}">
									<div class="form-group" id="answer-input"
										style="display: inline;">
										<div class="col-md-12">
											<label class="col-sm-2 text_title">答案：</label>
											<div class="col-sm-10 option_div">
												<c:forEach items="${question.answers }" var="answer"
													...
													<div class="option_item original_item">
														<div class="col-sm-7">
															<textarea class="form-control" placeholder="正确答案"
																id="correct_answer" name="correct_answer">${answer }</textarea>
															<label class="error" id="answerError"></label>
														</div>
														<c:if test="${status.last }">
															<div class="col-sm-1 file-upload">
