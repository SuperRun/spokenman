...
<div class="layui-fluid management" id="app">
    <div class="layui-main" style="min-height: 400px">
      ...
      <div class="layui-row" style="margin-top: 20px;">
        ...
        <div class="layui-row">
            ...
            <!--学习资源清单-->
            <div class="layui-col-md4 layui-col-md-offset1" id="list" style="display: none">
                <fieldset class="layui-elem-field layui-field-title">
            ...
            <!--考试情况-->
            <div class="layui-col-md4 layui-col-md-offset1" id="test" style="display: none">
                <fieldset class="layui-elem-field layui-field-title">
