...
//        $('#'+creationOrganization.ids.organizationInfo).validate(creationOrganization.validateData);
    ...
    $('#' + creationOrganization.ids.organizationInfo).validate({
        ...
        submitHandler: function () {
            ...
            if (orgType == 1) {
                //市机构
                parentId = $('#' + creationOrganization.ids.provinceOrgOrg).val();
            } else if (orgType == 2) {
                //    区机构
                parentId = $('#' + creationOrganization.ids.cityOrg).val();
            } else if (orgType == 3) {
                //车企
                parentId = $('#' + creationOrganization.ids.districtOrg).val();
            }
            ...
            modifyOrg.funcs.modifyOrg(parentId, name, shortName,
