    ...
    <div class="row">
        ...
        <div class="col-md-10">
            <div class="panel panel-primary">
                ...
                <div class="panel-heading">员工基本信息<span id="operation"><a href="#" id="hide"
                ...
                <div class="panel-body">
                    ...
                    <div class="col-md-10">
                        <form class="form-horizontal" id="organizationInfo">
                            ...
                            <div class="form-group">
                                <label for="idCard" class="col-sm-3 control-label control-head">身份证号:</label>
                                <span class="control-answer col-sm-9" id="idCard">
                                    <c:if test="${not empty member.sfzNo}">
                                        ${member.sfzNo}
                                    </c:if>
                                    <c:if test="${empty member.sfzNo}">
                                        无
                                    </c:if>
                                </span>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <c:if test="${not empty org}">
                                    <a href="<%=basePath %>organization/${org.id }"
                                       target="_blank">${org.name }(${org.shortName})</a>
                                </c:if>
                                <c:if test="${empty org}">
                                    无
                                </c:if>
