        ...
        <div class="courses" style="padding-bottom: 0px;">
            <div class="courses-info">
                <div class="path">
                    ...
                    <span class="path-split">\</span><a href="/course/list?c=fe">{{res.typeIdName}}</a>
                </div>
                ...
                <div class="statics">
                    <div class="teacher-info l">
                        <a href="/u/494742/courses?sort=publish" target="_blank">
                        ...
                        <span class="tit">
                            <a>{{res.lecturerUserName}}</a>
                        </span>
                        <span class="job">{{res.lecturerName}}</span>
                        <div class="teacher-course">
                            <div class="teacher-course-arrow"><span></span></div>
                        </div>
                    </div>
                    <div class="static-item l">
                        <span class="meta">学分</span><span class="meta-value">{{res.score}}</span>
                    </div>
                    <div class="static-item l">
                        <span class="meta">时长</span><span class="meta-value"> {{res.durationHour}}小时{{res.durationMinute}}分{{res.durationSecond}}秒</span>
                    </div>
                    <!--<div class="static-item l">
                            ...
                            <div class="chapter course-wrap">
                                ...
                                <ul class="video">
                                    <li data-media-id="17023"><em class="laststudy">最近学习</em>
                                        <a  class="media-item" @click="learnRes">
                                            <i class="layui-icon ing">&#xe617;</i>
                                            <i class="layui-icon type">&#xe652;</i>
                                            <span> {{res.name}}</span>
                                            <span>({{res.durationHour}}:{{res.durationMinute}}:{{res.durationSecond}})</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
            ...
            <div class="course-wrap course-aside-info">
                <div class="learn-btn">
                    <div class="learn-info">
                        <span>已学 {{userRes.process}}% </span>学习耗时{{userRes.learnedHour}}小时{{userRes.learnedMinute}}分{{userRes.learnedSecond}}秒
                    </div>
                    <div class="layui-progress layui-progress-big" lay-filter="learningProgress">
                        <div class="layui-progress-bar layui-bg-red" lay-percent="0%"></div>
                    </div>
                    <div v-if="userRes.status==0"> 
                    	<a @click="learnRes" class="layui-btn layui-btn-danger">开始学习</a>
                    </div>
                    <div v-else-if="userRes.status==1"> 
                    	<a v-bind:href="'/video/'+resId+'?id='+userRes.id" class="layui-btn layui-btn-danger">继续学习</a>
                    </div>
                    <div v-else> 
                    	<a v-bind:href="'/video/'+resId+'?id='+userRes.id" class="layui-btn layui-btn-danger">完成学习</a>
                    </div>
                </div>
                <div class="course-info-tip">
                    <dl class="first">
                        <dt>课程须知</dt>
                        <dd class="autowrap">1. 有html，css，js前端开发基础
...
<script src="../../js/resources/resourceDetail.js"></script>
</body>
</html>