...
<div id="app">
	...
	<div style="margin-top: 20px;">
        <form id="insert-info" class="layui-form"  lay-filter="editForm">
	        <div class="layui-form-item layui-form-text">
	            <div class="layui-inline">
	                <label class="layui-form-label">经历名称</label>
	                <div class="layui-input-inline" >
	                   <input class="layui-input" v-model="editLecturer.name"/>
	                </div>
	            </div>	            
	        </div>	
			...
			<div class="layui-form-item">
	            <div class="layui-inline">
	                ...
	                <div class="layui-input-inline">
					  <select class="getType" id="editTypeId" name="typeId" lay-verify="required" lay-search="">
			...
			<div class="layui-form-item">
	            <div class="layui-inline">
	                ...
	                <div class="layui-input-inline">
			        <select id="editLevel" name="level" lay-verify="required" lay-search="">
	        ...
	        <div class="layui-form-item layui-form-text">
	            ...
	            <div class="layui-input-block">
	                <textarea style="width:60%;" placeholder="请输入内容" class="layui-textarea" v-model="editLecturer.introduction"></textarea>
	            </div>
	        </div>		    

			<div class="layui-btn-container" style="text-align :center;line-height: 48px ">
			  <button type="button" class="layui-btn  layui-btn-radius " style="width: 150px" @click="updateLecturer">提交</button> 
...
<script src="../../js/user/editLecturer.js"></script>
