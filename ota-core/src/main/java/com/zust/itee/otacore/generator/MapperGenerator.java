package com.zust.itee.otacore.generator;

import java.lang.reflect.Field;
import java.util.LinkedList;
import java.util.List;

import com.zust.itee.otacore.client.domain.Test;
...
public class MapperGenerator {
    ...
    private static void init(Class clazz) {
        ...
        for (int i = 0; i < fields.length; i++) {
            ...
            String columnName = ConvertUtil.convertColumn(fieldName);
    ...
    private static String getMapperName(Class clazz) {
        ...
        String mapperPackage = packageName.substring(0, packageName.lastIndexOf("."));
        mapperPackage = mapperPackage.substring(0, mapperPackage.lastIndexOf("."));
        mapperPackage += MAPPER_IMPL_MAPPER;
