...
<head>
    ...
    <script src="<%=path%>/media/js/do/hr/excel_upload/driver_work_his.js"></script>
    ...
    <div class="row">
        ...
        <div class="col-md-9">
            <div class="block block-two">
                ...
                <div class="block-heading"><span>驾驶员工作经历导入</span></div>
                <div class="block-body">
                    <div class="col-md-12">
                        <form class="form-horizontal employee_form">
                            ...
                            <br>
                            <a href="<%=path%>/media/excel/tdriver_work_history.xlsx" >导入Excel模板下载</a>
...
<!--message end-->
<form class="form-horizontal" id="picUploadForm" action="<%=path %>/excel/excelHis" role="form" method="post" enctype="multipart/form-data" >
    <!-- 实际的file控件 -->
