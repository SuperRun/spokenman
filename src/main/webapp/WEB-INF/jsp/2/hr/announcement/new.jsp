...
<head>
    ...
    <script type="text/javascript" src="<%=path %>/media/js/do/hr/announcement/new.js"></script></head>
...
<div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="block block-two">
                    ...
                    <div class="block-heading"><span>新建${typeEnum.info}</span></div>
                        ...
                        <div class="col-md-12">
                            <form class="form-horizontal" id="departmentInfo">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        <textarea class="form-control" id="body" name="body" style="height: 324px;" ></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-10">
                                        ...
                                        <input type="text" id="fileCover" class="form-control"  placeholder="点击选择上传附件"
                                               onclick="$('input[id=useFile]').click();" onkeydown="return false;">
    ...
    <form class="form-horizontal" id="fileUploadForm" action="<%=path %>/announcement/file" role="form" method="post" enctype="multipart/form-data">
        <!-- 实际的file控件 -->
        <input id="useFile" type="file" name="useFile" style="display:none">
    </form>
    <input id="annType" value="${typeEnum.type}" type="text" style="display:none" >
    <!--footer end-->
</div>
<script>
    ...
    $('input[id=useFile]').change(function() {
        $('#fileCover').val($(this).val());
        $('#fileUploadForm').ajaxSubmit({
            success: function (data) {
                if(typeof(data)!='object') data=JSON.parse(data);
                console.info(data.errorInfo);
                $('#departmentInfo').find('input[name=fileName]').val(data.files);
                console.info(data.files);
                $('#filePreview').attr('src','${pageContext.request.contextPath}/'+data.files);
