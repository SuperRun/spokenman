					...
					<div class="block block-two" id="paper_content">
						...
						<div class="block-heading">
							...
							<div id="heading_right" class="heading_right">
								<div id="count">
									共<label id="count_question">0</label>道, 共<label
										id="count_score">0</label>分
								</div>
								...
								<c:forEach items="${questionTypes }" var="questionType">
									<li class="list_item">
										...
										<div class="col col-md-3 text_field">
											<input type="text" class="text subtotal" disabled="disabled">题
										</div>
										<div class="col col-md-3 text_field">
						...
						<div class="col-md-12">
							<div id="message_top">
								...
								<div class="message_item col-md-7">
									试卷总题数：非必选题（<span class="message_num" id="selected_question">0</span>题）+必选题（<span
								...
								<div class="message_item col-md-7">
									试卷总分数：非必选题（<span class="message_num" id="selected_score">0</span>分）+必选题（<span
							...
							<div id="passInfo">
								<div class="col-md-5">
									及格方式： <label class="radio-inline"> <input type="radio"
										name="passingType" id="inlineRadio1" value="number"
										class="radio_group" checked="checked"> 及格题数
									</label> <label class="radio-inline"> <input type="radio"
										name="passingType" id="inlineRadio2" value="score"
										class="radio_group"> 及格分数
									</label>
								</div>
							...
							<div id="message_content">
								<div id="paper_title">
									<textarea id="title_container"
										class="text_area form-control input-lg" placeholder="试卷名字（必填）"></textarea>
								</div>
								<div id="paper_describe">
									<textarea id="describe_container"
										class="text_area form-control" placeholder="试卷描述，该信息考生不可见（必填）"></textarea>
								</div>
							</div>
							<input type="button" class="btn btn-primary paper_btn"
								value="保存试卷" id="paperKeep"
								onclick="savePaperInfo('<%=basePath%>')"> <input
								type="button" class="btn btn-primary paper_btn" value="保存试卷"
								id="paperPreview" data-toggle="modal"
								data-target="#preview_Modal"
								onclick="savePaperInfo('<%=basePath%>')">
						</div>
						<!--<div class="col-md-1"></div>-->
					</div>
					<!--填写试卷信息 end-->
